import 'package:day_task_app/control/valid_text_form.dart';
    ...
    return Column(
      ...
      children: [
          ...
          Column(
            ...
            children: [
              ...
              const TextFormFieldWidget(
                icon: Icons.person,
                hintText: AppText.textFullName,
                validator: ValidForm.nameValid,
              ),
              const SizedBox(height: 10),
            ],
          ),
        ...
        const TextFormFieldWidget(
          ...
          validator: ValidForm.emailValid,
        ),
